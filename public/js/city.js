...
/* harmony default export */ __webpack_exports__["default"] = ({
    data: function data() {
        return {
            counties_array: [{ text: '台北市', value: 'A' }, { text: '基隆市', value: 'B' }, { text: '新北市', value: 'C' }],
            counties_selected: ''
        };
    },
    methods: {
...
var render = function() {
  ...
  return _c(
    "button",
    { attrs: { id: "show" }, on: { click: _vm.ShowPostalCode } },
  ...
  return _c(
    ...
    [
      ...
      _vm._l(_vm.counties_array, function(counties, index) {
        return _c(
          "option",
          { key: counties.value, domProps: { value: index } },
  ...
  return _c(
    ...
    [
      ...
      _vm._l(_vm.districts_array, function(districts, index) {
        return _c(
          "option",
          { key: districts.value, domProps: { value: index } },
