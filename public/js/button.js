...
var btn = new Vue({
  ...
  // },
  methods: {
    showAdd: function showAdd(index) {
      var status = this.namelist[index].status;
      var value = true;
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\laravel_vue\resources\js\button.js */"./resources/js/button.js");
