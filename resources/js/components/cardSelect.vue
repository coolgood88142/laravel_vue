				...
				<div class="card-body">
					...
					<div class="col">
						<input type="button" class="btn btn-primary"
							:id="sendId" name="send" value="送出" @click="changeCard()">
					</div>

				</div>
			</div>
		</div>
		<addCard v-if="showModal" @close="showModal = false"
			:card-number="cardNumber" v-on:send-card="sendCard"></addCard>
	</form>
</template>
